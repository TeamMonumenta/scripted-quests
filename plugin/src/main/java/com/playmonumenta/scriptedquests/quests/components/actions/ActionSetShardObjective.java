...
public class ActionSetShardObjective implements ActionBase {
	...
	public ActionSetShardObjective(JsonElement element) throws Exception {
		if (!element.isJsonArray()) {
			throw new Exception("Set Shard Objective is not an instance of an array!");
		}
